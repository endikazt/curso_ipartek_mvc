...
<body>
    ...
    <a style="padding-right: 1em;" href="/index.html"> Volver a la pagina de inicio </a> 
    ...
    <p id="parrafo4" style="margin: auto;"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi et tempore velit asperiores illo suscipit laborum, enim quis nisi dolorum facilis tenetur provident corrupti obcaecati earum recusandae vitae amet error. </p>
    ...
    <img style="margin: auto;text-align: center;" height="275" width="300" src="/images/awake.jpg" alt="Awake but a what cost meme">

    <img  height="425" width="300" src="http://www.campus.formacion.ipartek.com/moodle/pluginfile.php/4535/mod_resource/content/1/html5-cheat-sheet.png" alt="Tabla de etiquetas HTML">
    <hr>
