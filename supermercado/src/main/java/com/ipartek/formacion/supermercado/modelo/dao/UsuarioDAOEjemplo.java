...
public class UsuarioDAOEjemplo {

	private static UsuarioDAOEjemplo INSTANCE = null;
	...
	private UsuarioDAOEjemplo() {
		super();
	}

	public static synchronized UsuarioDAOEjemplo getInstance() {

		if (INSTANCE == null) {
			INSTANCE = new UsuarioDAOEjemplo();
		}
